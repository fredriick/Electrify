      ...
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Manage all disputed orders in the marketplace</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Disputed Orders</p>
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
          Showing {filteredOrders.length} disputed orders
        </div>
        {viewMode === "grid" && (
